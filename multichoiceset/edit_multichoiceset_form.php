...
require_once($CFG->libdir . '/pagelib.php');
 global $PAGE;
 $PAGE->requires->js(new moodle_url('Edit.js'));
 $PAGE->requires->jquery(new moodle_url('jq.js'));
...
//        $mform->addElement('button','btntf','true/false question');
//        
//            if (isset($_POST['btntf'])){
//                
//
//            
//        }
        ...
        $mform->addElement('select', 'QuestionType', get_string('QuestionType', 'qtype_multichoice'),array(                
                1 => get_string('multichoice'),
                0 => get_string('true&false')),
           array('onchange' => 'javascript:myFunctionToDoSomething();'));   

        $mform->addElement('text', 'questions',
                'Answer numbers', null);
        $mform->setDefault('questions', '0');
        
        $mform->addElement('text', 'minus',
                'Minuses', null);
        $mform->setDefault('minus', '0');
    ...
    protected function get_per_answer_fields($mform, $label, $gradeoptions,
        ...
        $repeated[] = $mform->createElement('checkbox', 'correctanswer',
                get_string('correctanswer', 'qtype_multichoiceset'),'',array('onclick' => 'javascript:myFunction(this.id);'));
    ...
    protected function data_preprocessing($question) {
        ...
        if (!empty($question->options)) {
            ...
            $question->questions = $question->options->questions;
            $question->minus = $question->options->minus;
     ...
     * @return string the question type name      multichoiceset
     */
