...
class qtype_multichoiceset extends question_type {
    ...
    public function save_question_options($question) {
        ...
        $options->questions = $question->questions; //value from gui to db **save value in db
        $options->minus = $question->minus;
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        $question->questions = $questiondata->options->questions; //***** initialise in gui*****
        $question->minus = $questiondata->options->minus;
